...
const TableStatistikAdmin = () => {
  return (
    <div className="p-2 shadow-md border rounded-lg w-full">
      <h1 className="text-center text-sm text-gray-800 font-bold">
        Table Sumber Daya dan Cadangan
      </h1>

      <div className="relative overflow-auto h-[11rem] mt-1">
...
export default TableStatistikAdmin;
